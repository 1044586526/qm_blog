...
import com.qm.enums.UserStatusEnum;
import com.qm.mapper.UserAuthMapper;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.qm.strategy.context.SocialLoginStrategyContext;
import com.qm.util.*;
...
import static com.qm.common.ResultCode.ERROR_MUST_REGISTER;
...
public class UserAuthServiceImpl extends ServiceImpl<UserAuthMapper, UserAuth> implements UserAuthService {
    ...
    public ResponseResult emailRegister(EmailRegisterDTO vo) {
        ...
        WebConfig config = webConfigService.getOne(new LambdaQueryWrapper<WebConfig>().last(LIMIT_ONE));
