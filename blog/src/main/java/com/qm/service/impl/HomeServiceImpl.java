...
import com.qm.vo.CategoryCountVO;
import com.qm.vo.HomeDataVO;
...
public class HomeServiceImpl {
    ...
    public ResponseResult webSiteInfo() {
        ...
        //文章分类标签
        Integer articleCount = articleMapper.selectCount(new LambdaQueryWrapper<BlogArticle>().eq(BlogArticle::getIsPublish, PUBLISH.getCode()));
