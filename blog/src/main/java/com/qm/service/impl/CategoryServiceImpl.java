...
import com.qm.vo.CategoryVO;
import com.qm.entity.Category;
import com.qm.mapper.CategoryMapper;
...
import static com.qm.common.ResultCode.CATEGORY_IS_EXIST;
import static com.qm.common.ResultCode.CATEGORY_IS_TOP;
...
public class CategoryServiceImpl extends ServiceImpl<CategoryMapper, Category> implements CategoryService {
    ...
    public ResponseResult top(Long id) {
        Category category = baseMapper.selectOne(new LambdaQueryWrapper<Category>().orderByDesc(Category::getSort).last(LIMIT_ONE));
