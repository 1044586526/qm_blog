...
public class ArticlesController {
    ...
    @BackgroundOperationLogger(value = "保存文章")
    ...
    @BackgroundOperationLogger(value = "修改文章")
    ...
    @BackgroundOperationLogger(value = "删除文章")
    ...
    @BackgroundOperationLogger(value = "批量删除文章")
    ...
    @BackgroundOperationLogger(value = "置顶文章")
    ...
    @BackgroundOperationLogger(value = "发布或下架文章")
    ...
    @BackgroundOperationLogger(value = "文章SEO")
    ...
    @BackgroundOperationLogger(value = "文章爬虫")
