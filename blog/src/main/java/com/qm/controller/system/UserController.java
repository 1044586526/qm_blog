...
public class UserController {
    ...
    @BackgroundOperationLogger(value = "添加用户")
    ...
    @BackgroundOperationLogger(value = "修改用户")
    ...
    @BackgroundOperationLogger(value = "删除用户")
    ...
    @BackgroundOperationLogger(value = "修改密码")
    ...
    @BackgroundOperationLogger(value = "踢人下线")
